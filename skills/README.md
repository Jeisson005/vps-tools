...
| **`user-task-management`** | OpenCode & Hermes | Personal task management in ClickUp as intelligent chief-of-staff: fully autonomous reads+writes, auto-suggests estimate+due date+priority (✨), proactive triage by age, execution help, calendar scheduling. Only confirms on demand or destructive deletes. | `clickup` via MCP Gateway (`:8005/clickup`) |
