...
> [!WARNING]
> **Channel Awareness:** If the user is chatting via **Telegram, Discord, Web Chat, or CLI terminal**, they are NOT necessarily watching the VNC monitor `:1`. 
> - If the user wants to enter credentials, solve 2FA, or log in through a web page, do **NOT** open Chrome in `:1`. Use **`steel-session create`** in **`browser-automation`** to give them a **Live Viewer web link**.
